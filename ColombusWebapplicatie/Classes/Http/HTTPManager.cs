...
namespace ColombusWebapplicatie.Classes.Http
{
    public static class HttpManager
    {
        ...
        /// <param name="baseUrl"></param>
        /// <returns></returns>
        public static T WebservicePostRequest<T>(string url, HttpRequestBase request, T objectToPost, Dictionary<string, string> headers = null, Dictionary<string, string> parameters = null, string baseUrl = LOCAL_BASE_URL)
        {
